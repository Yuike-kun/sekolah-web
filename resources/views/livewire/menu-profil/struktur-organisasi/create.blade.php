<div>
    <x-page-title pagePretitle="Menyunting Struktur Organisasi" pageTitle="Sunting Struktur Organisasi">
        <x-backend.button.back name="Kembali" route="menu-profil.struktur-organisasi.index" />
    </x-page-title>
    ...
    <form wire:submit="save" id="data">
        <div class="card" wire:loading.class.delay="card-loading" wire:offline.class="card-loading">
            <div class="card-header d-flex">
                <h5 class="my-auto py-2">Sunting Struktur Organisasi</h5>
            </div>
            <div class="card-body">
