<div>
    <x-page-title pagePretitle="Tambah Akun" pageTitle="Menambah Akun">
            ...
            <div class="card" wire:loading.class.delay="card-loading" wire:offline.class="card-loading">
                <form wire:submit.prevent="save" id="data">
                    <div class="card-header d-flex">
                        <h5 class="my-auto py-2">Tambah Akun</h5>
                    </div>
                    <div class="card-body">
                            ...
                            @if ($this->pilihSiswa && $this->pilihSiswa == 'Tanpa Siswa')
                                <div class="card-body border-top">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <x-backend.form.input confirm='NISN siswa akan di jadikan password.'
                        ...
                        @else
                            <div class="card-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <x-backend.form.input label='Password' wire:model.defer="password"
                                            name="password" type="password" placeholder="Masukkan Password" />
                                    </div>
                                    <div class="col-lg-6 col-12">
                                        <x-backend.form.input label='Konfirmasi Password'
