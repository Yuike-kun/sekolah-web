...
class MultiStepRegistration extends Component
{
    ...
    public function validateData()
    {
        ...
        if ($this->currStep == 5) {
            $this->validate([
                'file_foto'           => 'required|image|max:4096',
                'file_ijazah'         => 'required|image|max:4096',
                'file_raport'         => 'required|image|max:4096',
    ...
    public function save()
    {
        ...
        try {
            ...
            $ppdb = PPDB::create([
                ...
                'student_files'       => $documentFiles->id,
            ]);
